...
export const fr: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "ID de l'agent",
      detailDirectory: "Répertoire",
      text: "Texte",
      file: "Fichier",
    },
    speak: {
  ...
  sessionPicker: {
    ...
    search: "Rechercher un nom de session",
    empty: "Aucune session d’agent ouverte",
    untitled: "Session sans titre",
    rename: "Renommage intelligent",
    prompt: "Consignes de nommage",
    generate: "Générer un aperçu",
    apply: "Appliquer ({{count}})",
    suggestedTitle: "Nom proposé",
    invalidPrompt: "Saisissez des consignes de 4 000 caractères maximum.",
    invalidTitle: "Le nom doit contenir entre 1 et 200 caractères.",
    failed: "Impossible de renommer les sessions. Réessayez.",
    skipped: "{{count}} sessions sans historique disponible ont été ignorées.",
    closed: "Cet onglet de session a été fermé.",
    updateHost: "Mettez cet hôte à jour pour renommer les sessions.",
    tooMany: "Renommez au maximum 100 sessions à la fois.",
    defaultPrompt:
      "Nommez chaque session selon sa tâche concrète la plus récente, dans la langue de la conversation. Conservez les noms distinctifs de projets, fichiers ou fonctionnalités et évitez les noms génériques.",
    results: {
      applied: "Appliqué",
      conflict: "Le nom a changé. Générez un nouvel aperçu.",
      missing: "Cette session n’est plus disponible.",
      failed: "Échec de l’application. Réessayez.",
    },
  },
  skillPicker: {
  ...
  agentAutocomplete: {
    ...
    noSessions: "Aucune session d'agent trouvée",
    noProfiles: "Aucun profil d'agent trouvé",
  ...
  subagents: {
    openParent: "Revenir à l’agent parent",
    title: "Sous-agents",
