...
export const ptBR: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "ID do agente",
      detailDirectory: "Diretório",
      text: "Texto",
      file: "Arquivo",
    },
    speak: {
  ...
  sessionPicker: {
    ...
    search: "Buscar nomes de sessões",
    empty: "Nenhuma sessão de agente aberta",
    untitled: "Sessão sem título",
    rename: "Renomear com IA",
    prompt: "Instruções de nomes",
    generate: "Gerar prévia",
    apply: "Aplicar ({{count}})",
    suggestedTitle: "Nome sugerido",
    invalidPrompt: "Insira instruções com até 4.000 caracteres.",
    invalidTitle: "O nome deve ter entre 1 e 200 caracteres.",
    failed: "Não foi possível renomear as sessões. Tente novamente.",
    skipped: "{{count}} sessões sem histórico disponível foram ignoradas.",
    closed: "Esta aba de sessão foi fechada.",
    updateHost: "Atualize este host para renomear sessões com IA.",
    tooMany: "Renomeie no máximo 100 sessões por vez.",
    defaultPrompt:
      "Nomeie cada sessão pela tarefa concreta mais recente, no idioma da conversa. Preserve nomes distintos de projetos, arquivos ou recursos e evite nomes genéricos.",
    results: {
      applied: "Aplicado",
      conflict: "O nome mudou. Gere outra prévia.",
      missing: "A sessão não está mais disponível.",
      failed: "Não foi possível aplicar. Tente novamente.",
    },
  },
  skillPicker: {
  ...
  agentAutocomplete: {
    ...
    noSessions: "Nenhuma sessão de agente encontrada",
    noProfiles: "Nenhum perfil de agente encontrado",
  ...
  subagents: {
    openParent: "Voltar ao agente pai",
    title: "Subagentes",
