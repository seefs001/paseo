...
export const ar: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "معرّف الوكيل",
      detailDirectory: "الدليل",
      text: "نص",
      file: "ملف",
    },
    speak: {
  ...
  sessionPicker: {
    ...
    search: "ابحث عن أسماء الجلسات",
    empty: "لا توجد جلسات وكيل مفتوحة",
    untitled: "جلسة بلا عنوان",
    rename: "إعادة تسمية ذكية",
    prompt: "تعليمات التسمية",
    generate: "إنشاء معاينة",
    apply: "تطبيق ({{count}})",
    suggestedTitle: "الاسم المقترح",
    invalidPrompt: "أدخل تعليمات تسمية لا تتجاوز 4000 حرف.",
    invalidTitle: "يجب أن يتكون الاسم من حرف واحد إلى 200 حرف.",
    failed: "تعذرت إعادة تسمية الجلسات. حاول مجددًا.",
    skipped: "تم تخطي {{count}} جلسات دون سجل محادثة متاح.",
    closed: "أُغلقت علامة تبويب هذه الجلسة.",
    updateHost: "حدّث هذا المضيف لاستخدام إعادة التسمية الذكية.",
    tooMany: "يمكن إعادة تسمية 100 جلسة كحد أقصى في المرة الواحدة.",
    defaultPrompt:
      "سمّ كل جلسة حسب أحدث مهمة محددة بلغة المحادثة. احتفظ بأسماء المشاريع والملفات والميزات المميزة وتجنب الأسماء العامة.",
    results: {
      applied: "تم التطبيق",
      conflict: "تغيّر الاسم. أنشئ معاينة جديدة.",
      missing: "الجلسة لم تعد متاحة.",
      failed: "تعذر التطبيق. حاول مجددًا.",
    },
  },
  skillPicker: {
  ...
  agentAutocomplete: {
    ...
    noSessions: "لم يتم العثور على جلسات وكيل",
    noProfiles: "لم يتم العثور على ملفات تعريف الوكيل",
