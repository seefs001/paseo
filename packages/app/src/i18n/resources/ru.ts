...
export const ru: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "ID агента",
      detailDirectory: "Каталог",
      text: "Текст",
      file: "Файл",
    },
    speak: {
  ...
  sessionPicker: {
    title: "Открытые сеансы",
    search: "Поиск по названиям",
    empty: "Нет открытых сеансов агента",
    untitled: "Сеанс без названия",
    rename: "Умное переименование",
    prompt: "Инструкции для названий",
    generate: "Создать предпросмотр",
    apply: "Применить ({{count}})",
    suggestedTitle: "Предложенное название",
    invalidPrompt: "Введите инструкции длиной до 4000 символов.",
    invalidTitle: "Название должно содержать от 1 до 200 символов.",
    failed: "Не удалось переименовать сеансы. Повторите попытку.",
    skipped: "Пропущено сеансов без истории: {{count}}.",
    closed: "Вкладка этого сеанса закрыта.",
    updateHost: "Обновите хост для умного переименования.",
    tooMany: "За один раз можно переименовать не более 100 сеансов.",
    defaultPrompt:
      "Назовите каждый сеанс по его последней конкретной задаче на языке беседы. Сохраните названия проектов, файлов или функций и избегайте общих названий.",
    results: {
      applied: "Применено",
      conflict: "Название изменилось. Создайте новый предпросмотр.",
      missing: "Сеанс больше недоступен.",
      failed: "Не удалось применить. Повторите попытку.",
    },
  },
  skillPicker: {
  ...
  agentAutocomplete: {
    ...
    noSessions: "Сессии агентов не найдены",
    noProfiles: "Профили агентов не найдены",
