...
export const ko: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "에이전트 ID",
      detailDirectory: "디렉터리",
      text: "텍스트",
      file: "파일",
    },
    speak: {
  ...
  sessionPicker: {
    title: "열린 세션",
    search: "세션 이름 검색",
    empty: "열린 에이전트 세션이 없습니다",
    untitled: "제목 없는 세션",
    rename: "이름 자동 제안",
    prompt: "이름 지정 지침",
    generate: "미리보기 생성",
    apply: "적용 ({{count}})",
    suggestedTitle: "제안된 이름",
    invalidPrompt: "이름 지정 지침을 4,000자 이내로 입력하세요.",
    invalidTitle: "이름은 1~200자여야 합니다.",
    failed: "이름을 변경하지 못했습니다. 다시 시도하세요.",
    skipped: "대화 기록이 없는 세션 {{count}}개를 건너뛰었습니다.",
    closed: "이 세션 탭이 닫혔습니다.",
    updateHost: "자동 이름 지정을 사용하려면 호스트를 업데이트하세요.",
    tooMany: "한 번에 최대 100개 세션의 이름을 변경할 수 있습니다.",
    defaultPrompt:
      "최근의 구체적인 작업을 기준으로 대화 언어로 간결한 이름을 만드세요. 프로젝트, 파일, 기능 이름을 유지하고 일반적인 이름은 피하세요.",
    results: {
      applied: "적용됨",
      conflict: "이름이 변경되었습니다. 미리보기를 다시 생성하세요.",
      missing: "세션을 사용할 수 없습니다.",
      failed: "적용하지 못했습니다. 다시 시도하세요.",
    },
  },
  skillPicker: {
    loading: "스킬 로딩 중…",
  ...
  agentAutocomplete: {
    ...
    noSessions: "에이전트 세션을 찾을 수 없습니다",
    noProfiles: "에이전트 프로필을 찾을 수 없습니다",
    noMentions: "에이전트 세션, 프로필 또는 파일을 찾을 수 없습니다",
