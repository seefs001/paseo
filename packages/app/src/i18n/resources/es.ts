...
export const es: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "ID del agente",
      detailDirectory: "Directorio",
      text: "Texto",
      file: "Archivo",
    },
    speak: {
  ...
  sessionPicker: {
    ...
    search: "Buscar nombres de sesiones",
    empty: "No hay sesiones de agente abiertas",
    untitled: "Sesión sin título",
    rename: "Renombrar con IA",
    prompt: "Instrucciones de nombres",
    generate: "Generar vista previa",
    apply: "Aplicar ({{count}})",
    suggestedTitle: "Nombre sugerido",
    invalidPrompt: "Introduce instrucciones de hasta 4000 caracteres.",
    invalidTitle: "El nombre debe tener entre 1 y 200 caracteres.",
    failed: "No se pudieron renombrar las sesiones. Inténtalo de nuevo.",
    skipped: "Se omitieron {{count}} sesiones sin historial disponible.",
    closed: "Esta pestaña de sesión se ha cerrado.",
    updateHost: "Actualiza este host para renombrar sesiones con IA.",
    tooMany: "Renombra como máximo 100 sesiones a la vez.",
    defaultPrompt:
      "Nombra cada sesión por su tarea concreta más reciente en el idioma de la conversación. Conserva nombres distintivos de proyectos, archivos o funciones y evita nombres genéricos.",
    results: {
      applied: "Aplicado",
      conflict: "El nombre cambió. Genera otra vista previa.",
      missing: "La sesión ya no está disponible.",
      failed: "No se pudo aplicar. Inténtalo de nuevo.",
    },
  },
  skillPicker: {
  ...
  agentAutocomplete: {
    ...
    noSessions: "No se encontraron sesiones de agente",
    noProfiles: "No se encontraron perfiles de agente",
