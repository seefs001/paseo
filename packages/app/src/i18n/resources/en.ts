export const en = {
  ...
  sessionPicker: {
    ...
    empty: "No open agent sessions",
    untitled: "Untitled session",
    rename: "Smart rename",
    prompt: "Naming instructions",
    generate: "Generate preview",
    apply: "Apply ({{count}})",
    suggestedTitle: "Suggested title",
    invalidPrompt: "Enter naming instructions (up to 4,000 characters).",
    invalidTitle: "Use a non-empty title of at most 200 characters.",
    failed: "Could not rename sessions. Please try again.",
    skipped: "Skipped {{count}} sessions without available conversation history.",
    closed: "This session tab has been closed.",
    updateHost: "Update this host to use smart session renaming.",
    tooMany: "Rename at most 100 sessions at a time.",
    defaultPrompt:
      "Name each session by its most recent concrete task. Keep distinctive project, file, or feature names. Use the language of the conversation, keep titles concise, and avoid generic names such as Help or Discussion.",
    results: {
      applied: "Applied",
      conflict: "Name changed elsewhere. Generate a new preview.",
      missing: "Session is no longer available.",
  ...
  agentAutocomplete: {
    ...
    noProfiles: "No agent profiles found",
