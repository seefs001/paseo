...
export const zhCN: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      openAgentSession: "打开 Agent 会话附件",
      removeAgentSession: "移除 Agent 会话附件",
      openAgentProfile: "打开 Agent 配置附件",
      removeAgentProfile: "移除 Agent 配置附件",
    },
    errors: {
      failedToSend: "发送消息失败",
  ...
  sessionPicker: {
    ...
    apply: "应用（{{count}}）",
    suggestedTitle: "建议名称",
    invalidPrompt: "请输入命名提示词，最多 4000 字符。",
    invalidTitle: "名称不能为空，最多 200 字符。",
    failed: "重命名失败，请重试。",
    skipped: "已跳过 {{count}} 个没有可用对话记录的会话。",
    closed: "这个会话标签已关闭。",
    updateHost: "请更新主机以使用智能重命名。",
    tooMany: "每次最多重命名 100 个会话。",
    defaultPrompt:
      "根据每个会话最近的具体任务生成简洁的中文名称，保留能区分任务的项目、文件或功能名。优先使用“动作 + 对象”，避免“帮助”“讨论”等泛泛的名称。",
    results: {
      applied: "已应用",
      conflict: "名称已被修改，请重新生成预览。",
      missing: "会话已不可用。",
      failed: "应用失败，可以重试。",
    },
  },
  ...
  agentAutocomplete: {
    ...
    noFiles: "没有找到文件或目录",
    noSessions: "没有找到 Agent 会话",
    noProfiles: "没有找到 Agent 配置",
