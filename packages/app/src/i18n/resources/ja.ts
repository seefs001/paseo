...
export const ja: TranslationResources = {
  ...
  message: {
    ...
    attachments: {
      ...
      detailAgentId: "エージェント ID",
      detailDirectory: "ディレクトリ",
      text: "テキスト",
      file: "ファイル",
    },
    speak: {
  ...
  sessionPicker: {
    ...
    invalidPrompt: "命名の指示を4,000文字以内で入力してください。",
    invalidTitle: "名前は1〜200文字で入力してください。",
    failed: "名前を変更できませんでした。再試行してください。",
    skipped: "会話履歴のない{{count}}件をスキップしました。",
    closed: "このセッションタブは閉じられました。",
    updateHost: "自動命名にはホストを更新してください。",
    tooMany: "一度に変更できるのは100件までです。",
    defaultPrompt:
      "最近の具体的なタスクに基づいて、会話の言語で簡潔な名前を付けてください。プロジェクト、ファイル、機能名を残し、一般的な名前を避けてください。",
    results: {
      applied: "適用済み",
      conflict: "名前が変更されています。プレビューを再生成してください。",
      missing: "セッションを利用できません。",
      failed: "適用できませんでした。再試行してください。",
    },
  },
  skillPicker: {
    loading: "スキルを読み込み中…",
  ...
  agentAutocomplete: {
    ...
    noSessions: "エージェントセッションが見つかりません",
    noProfiles: "エージェントプロファイルが見つかりません",
